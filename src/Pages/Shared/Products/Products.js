...
const Products = ({product}) => {
    ...
    return (
        ...
        <Grid item xs={12} md={4} style={{boxShadow: "rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px"}} sx={{ wordSpacing:5, m: 1, py:2, borderRadius: '10px', border:'0.5px solid pink'}}>
          <img 
          width="340px"
          height=" 190px"
